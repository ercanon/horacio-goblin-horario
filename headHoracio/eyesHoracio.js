...
export async function setSchedule(sheetName, tabColor, channelID) {
    try {
...
export async function storeTimelapse(data) {
    try {
        const response = await axios.post(process.env.GAS_URL, {
...
export async function retrieveTimelapse(channelID) {
        try {
            const response = await axios.post(process.env.GAS_URL, {
